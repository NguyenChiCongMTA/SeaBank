namespace SafeControl
{
    partial class f8SendAPI_Sms
    {
        ...
        {
            this.header = new SafeControl.f8SendAPI_Sms_header();
            this.body = new SafeControl.f8SendAPI_Sms_body();
            this.SuspendLayout();
            // 
            // header
            // 
        ...
        public f8SendAPI_Sms_header header;
        public f8SendAPI_Sms_body body;
