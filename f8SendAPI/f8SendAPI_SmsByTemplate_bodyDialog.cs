...
namespace SafeControl
{
    ...
    /// </summary>
    public partial class f8SendAPI_SmsByTemplate_bodyDialog : fBaseDialog
    {
        /// <summary>
        /// Khởi tạo form 
        /// CreateBy: truongnm 17.03.2022
        /// </summary>
        public f8SendAPI_SmsByTemplate_bodyDialog()
        {
            InitializeComponent();
            //
            // Đăng ký event ở đây
        ...
        string sTempParamName = string.Empty;
        string sTempParamValue = string.Empty;
        public f8SendAPI_SmsByTemplate_body f8SendAPI_SmsByTemplate_body { set; get; }
        ...
        {
            //
            f8SendAPI_SmsByTemplate_body.sparam_name = param_name.Text;
            f8SendAPI_SmsByTemplate_body.sparam_value = param_value.Text;
        }
        /// <summary>
        ...
        {
            //
            sTempParamName = string.Empty;
            sTempParamValue = string.Empty;
            //
            f8SendAPI_SmsByTemplate_body.sparam_name = string.Empty;
            f8SendAPI_SmsByTemplate_body.sparam_value = string.Empty;
            //
            param_name.Text = string.Empty;
            param_value.Text = string.Empty;
        }
        #endregion
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
