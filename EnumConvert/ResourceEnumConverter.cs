...
namespace SafeControl.EnumConvert
{
    ...
    public class ResourceEnumConverter : System.ComponentModel.EnumConverter
    {
        ...
        static public string ConvertToString(System.Enum value)
        {
        ...
        /// </remarks>
        static public List<KeyValuePair<System.Enum, string>> GetValues(Type enumType, CultureInfo culture)
        {
            List<KeyValuePair<System.Enum, string>> result = new List<KeyValuePair<System.Enum, string>>();
            TypeConverter converter = TypeDescriptor.GetConverter(enumType);
            foreach (System.Enum value in System.Enum.GetValues(enumType))
            {
                KeyValuePair<System.Enum, string> pair = new KeyValuePair<System.Enum, string>(value, converter.ConvertToString(null, culture, value));
                result.Add(pair);
            }
            return result;
        }
        ...
        /// the DataValueField to "Key" and theDataTextField to "Value". 
        /// </remarks>
        static public List<KeyValuePair<System.Enum, string>> GetValues(Type enumType)
        {
