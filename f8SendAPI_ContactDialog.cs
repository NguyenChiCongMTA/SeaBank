...
namespace SafeControl
{
    ...
    /// </summary>
    public partial class f8SendAPI_ContactDialog : fBaseDialog
    {
        /// <summary>
        /// Khởi tạo form 
        /// CreateBy: truongnm 25.03.2022
        /// </summary>
        public f8SendAPI_ContactDialog()
        {
            InitializeComponent();
            //
        ...
        public app_object.Info_Contact info_mail { set; get; }
        public app_object.Info_Contact info_sms { set; get; }
        //
        ...
        public void Command_Run_Finish()
        {
            ...
            {
                MMessageBox.Information("Đã gửi liên hệ thành công!");
                // Ghi lại lịch sử
                oPersonHistory.AddPersonHistoryLog(DateTime.Now, sTenNhanVien, "Contact", string.Format("Chủ đề: {0}\nNội dung:\n{1}", utility_paramlist_subject.Text, utility_paramlist_bodym.Text));
                //
            }
            else
