...
namespace SafeControl
{
    ...
    /// </summary>
    public partial class f8SendAPI_Email_FileAttachDialog : fBaseDialog
    {
        /// <summary>
        /// Khởi tạo form 
        /// CreateBy: truongnm 17.03.2022
        /// </summary>
        public f8SendAPI_Email_FileAttachDialog()
        {
            InitializeComponent();
            //
            // Đăng ký event ở đây
        ...
        public f8SendAPI_EmailDialog f8SendAPI_EmailDialog { set; get; }
        ...
        public void Command_Run_Finish()
        {
            ...
            //
            f8SendAPI_EmailDialog.sfile_name = file_name.Text;
            f8SendAPI_EmailDialog.sfile_byte64 = file_byte64.Text;
        }
        /// <summary>
        ...
        public void Command_Reset_Text() 
        {
            ...
            //
            f8SendAPI_EmailDialog.sfile_name = string.Empty;
            f8SendAPI_EmailDialog.sfile_byte64 = string.Empty;
            //
